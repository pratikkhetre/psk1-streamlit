...
# predict the target from all the input features
       ...
       st.write("Developed By: Pratik Khetre")
       st.markdown("""Reach out to me on: [Twitter](https://twitter.com/pratik_khetre?s=09) |
       [Linkedin](https://www.linkedin.com/in/pratik-khetre-5a21121bb)
